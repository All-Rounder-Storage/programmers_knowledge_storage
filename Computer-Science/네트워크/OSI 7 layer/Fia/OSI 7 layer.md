...
- 신롸성 있는 전송을 보장하기 위한 계층으로, 물리 계층에서 발생할 수 있는 오류를 찾아내고 수정에 필요한 기능적, 절차적 수단을 제공
...
- 양 끝단의 응용 프로세스가 통신을 관리하기 위한 방법을 제공함
    - [반이중 방식(half-duplex)](#반이중-방식(half-duplex))
    - [전이중 방식(full Duplex)](#전이중-방식(full-duplex))
...
- [본문 돌아가기 백링크](#1계층-물리-계층-(Physical-Layer))
...
- [본문 돌아가기 백링크](#2계층-데이터-링크-계층-(DataLink-Layer))
...
- [본문 돌아가기 백링크](#3계층-네트워크-계층-(Network-Layer))
...
- [본문 돌아가기 백링크](#4계층-전송-계층-(Transmission-Control-Layer))
...
- [본문 돌아가기 백링크](#5계층-세션-계층-(Session-Layer))
...
- [본문 돌아가기 백링크](#6계층-표현-계층-(Presentation-Layer))
...
- [본문 돌아가기 백링크](#7계층-응용-계층-(Application-Layer))
